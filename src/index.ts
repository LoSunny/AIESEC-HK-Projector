...
import {newSource, removeSource, renameSource, setupServer, stopServer} from "./windows/observer/server";
...
declare const OBSERVER_WINDOW_WEBPACK_ENTRY: string;
declare const OBSERVER_WINDOW_PRELOAD_WEBPACK_ENTRY: string;
...
const createWindow = (): void => {
    ...
    ipcMain.handle("live-view", () => presentWindow.webContents.getMediaSourceId(presentWindow.webContents));
    ...
    setupServer(() => presentWindow, OBSERVER_WINDOW_WEBPACK_ENTRY);
};
